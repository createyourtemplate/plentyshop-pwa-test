<template>
  <div class="py-2">
    <div class="flex justify-between mb-2">
      ...
      <SfSwitch
        v-model="registerCytGACookieAsOptOut"
...
const { updateSetting, getSetting } = useSiteSettings('registerCytGACookieAsOptOut');

const registerCytGACookieAsOptOut = computed({
  get: () => !!getSetting(),
